...
function RDP_PersonalDetails() {
  ...
  function goto_currency_details() {
    if (name == ''){
      localStorage.setItem('RDP-personal-details-error', 'true');
      history.push('/rdp-currency-details');
    }
    else{
      localStorage.removeItem('RDP-personal-details-error');
      history.push('/rdp-currency-details');
    }
  }
  ...
  return (
      ...
      >
        ...
        >
          ...
          <div className="RDP-PD-checkbox-container">
            <Checkboxes />
          </div>
          ...
          <form>
            ...
            <div className="container">
              <div>
                <div 
                  className="RDP-PD-btn-section my-5 w-100"
                >
                  <Button 
                    onClick={goto_rdr}
...
export default RDP_PersonalDetails;
