...
import './FDP-CurrencyDetails.scss';
...
const FDP_CurrencyDetails = () => {
  ...
  function goto_terms() {
    if(dplaces == '') {
      localStorage.setItem('FDP-currency-error', 'true');
      history.push('/fdp-terms');
    }
    else {
      localStorage.removeItem('FDP-currency-error');
      history.push('/fdp-terms');
    }
  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="FDP-CD-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              ...
              <div className="container">
                <div>
                  <div className="FDP-CD-btn-section my-5">
                    <Button
                      onClick={goto_pd}
...
export default FDP_CurrencyDetails;
