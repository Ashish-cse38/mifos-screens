        ...
        >
          ...
          >
            ...
            <form>
              <div className="container">
                ...
                <div style={{fontSize: '20px'}}>
                  ...
                  <div class="custom-control custom-switch mb-4">
                    ...
                    <label class="custom-control-label FDP-Settings-text-small" for="customSwitch4">Is primary grouping by Amount</label>
                  </div>
              ...
              <div className="container">
                <div 
                  className="FDP-IRC-btn-section my-5 w-100"
                >
                  <Button 
