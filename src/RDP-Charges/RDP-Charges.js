...
function RDP_Charges() {
  ...
  function goto_accounting() {
    if (charges == '') {
      localStorage.setItem('RDP-charges-error', 'true');
      history.push('/rdp-accountingTab');
    }
    else{
      localStorage.removeItem('RDP-charges-error');
      history.push('/rdp-accountingTab');
    }
  }
...
return (
      ...
      >
        ...
        >
          ...
          >
            <div className="RDP-Charges-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              <div className="container">
                ...
                <div className="RDP-Charges-input-section my-4 py-4 ">
                  ...
                  <div className="RDP-Charges-tags-div d-flex mx-3 pb-2 overflow-auto">
                    {[...tags_set].map((entry) => (
                      <div
                        className="RDP-Charges-tag pt-2 px-2 d-flex mr-3 align-items-center"
                      >
              ...
              <div className="container">
                <div 
                  className="RDP-Charges-btn-section my-5 w-100"
                >
                  <Button 
                    onClick={goto_IRC}
