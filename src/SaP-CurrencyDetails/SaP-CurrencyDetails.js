...
import './SaP-CurrencyDetails.scss';
...
const SaP_CurrencyDetails = () => {
  ...
  function goto_terms() {
    if(dplaces == '') {
      localStorage.setItem('SaP-currency-error', 'true');
      history.push('/sap-terms');
    }
    else {
      localStorage.removeItem('SaP-currency-error');
      history.push('/sap-terms');
    }
  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="SaP-CD-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              ...
              <div className="container">
                <div>
                  <div className="SaP-CD-btn-section my-5">
                    <Button
                      onClick={goto_pd}
...
export default SaP_CurrencyDetails;
