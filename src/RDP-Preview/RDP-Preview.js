  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="RDP-Preview-checkbox-container">
              <Checkboxes />
            </div>
          ...
          >
            <div 
              className="RDP-Preview-btns my-5 w-100"
            >
              <Button
                className="py-2 RDP-Preview-btn-edit font-weight-medium text-break" 
              >
