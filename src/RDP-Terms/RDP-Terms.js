...
function RDP_Terms() {
  ...
  function goto_cd() {
    history.push('/rdp-currency-details');
  }

  function goto_settings() {
    if (def_amt == ''){
      localStorage.setItem('RDP-terms-error', 'true');
      history.push('/rdp-settings');
    }
    else{
      localStorage.removeItem('RDP-terms-error');
      history.push('/rdp-settings');
    }
  }
  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="RDP-Terms-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              ...
              <div className="container">
                <div>
                  <div 
                    className="RDP-Terms-btn-section my-5 w-100"
                  >
                    <Button 
                      onClick={goto_cd}
