...
import './RDP-CurrencyDetails.scss';
...
function RDP_CurrencyDetails() {
  ...
  function goto_terms() {
    if(dplaces == '') {
      localStorage.setItem('RDP-currency-error', 'true');
      history.push('/rdp-terms');
    }
    else {
      localStorage.removeItem('RDP-currency-error');
      history.push('/rdp-terms');
    }
  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="RDP-CD-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              ...
              <div className="container">
                <div>
                  <div className="RDP-CD-btn-section my-5">
                    <Button
                      onClick={goto_pd}
...
export default RDP_CurrencyDetails;
