...
import './SaP-PersonalDetails.scss';
...
const SaP_PersonalDetails = () => {
  let history = useHistory();
  const [name, setName] = useState('');

  function goto_currency_details() {
    if (name == ''){
      localStorage.setItem('SaP-personal-details-error', 'true');
      history.push('/sap-currency-details');
    }
    else{
      localStorage.removeItem('SaP-personal-details-error');
      history.push('/sap-currency-details');
    }
  }

  function goto_rdr() {
    history.push('/saving-products');
  }
  ...
  return (
      ...
      >
        ...
        >
          ...
          <div className="SaP-PD-checkbox-container">
            <Checkboxes />
          </div>
          ...
          <form>
            ...
            <div className="container">
              <div>
                <div 
                  className="SaP-PD-btn-section my-5 w-100"
                >
                  <Button 
                    onClick={goto_rdr}
...
export default SaP_PersonalDetails;
