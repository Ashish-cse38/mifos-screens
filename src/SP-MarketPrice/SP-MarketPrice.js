...
import { faArrowLeft, faArrowRight, faTimesCircle, faInfoCircle, faPlusCircle, faTimes } from '@fortawesome/free-solid-svg-icons';
...
const SP_MarketPrice = () => {
  ...
  function add_principal() {
    setPrincipals([...principals, <Principal id={uuidv4().toString()} validation={valid_From_date} array={principals}/>]);
  }
            ...
            <form>
              <div className="container">
                ...
                <div className="apply_pi">
                  ...
                  <div 
                    className="MP-blue-div w-100 py-4 mb-4"
                  >
              ...
              <div className="container">
                <div 
                  className="SP-MP-btn-section my-5 w-100"
                >
                  <Button 
