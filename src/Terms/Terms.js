        ...
        >
          ...
          >
            ...
            <div className="col-md-4 my-3">
                ...
                <input
                  id="short-name"
                  className="form-control h-75 px-3" 
                  type="search"
            ...
            >
              <div className="col-md-4 my-3">
                ...
                <select 
                  className="select custom-select custom-select-lg h-75 px-3"
                  style={{
                    padding: '3% 0 3% 0',
            ...
            <div>
              ...
              >
                <Button 
                  ...
                  className="terms-button py-3 ml-4 mr-5 btn-next border-0 rounded font-weight-semibold"
                >
                  Next
                ...
                <Button 
                  onClick={goto_cd}
                  className="terms-button py-3 ml-auto btn-prev border-0 rounded font-weight-medium" 
                >
