...
import './RDP-InterestRateChart.scss';
...
function RDP_InterestRateChart() {
  ...
  function goto_settings() {
    history.push('/rdp-settings');
  } 

  function goto_charges() {
    if (valid_from == '') {
      localStorage.setItem('RDP-IRC-error', 'true');
      history.push('/rdp-charges');
    }
    else {
      localStorage.removeItem('RDP-IRC-error');
      history.push('/rdp-charges');
    }
  }
  ...
  return (
      ...
      >
        ...
        >
          ...
          >
            <div className="RDP-IRC-checkbox-container">
              <Checkboxes />
            </div>
            ...
            <form>
              <div className="container">
                ...
                <div style={{fontSize: '20px'}}>
                  ...
                  <div class="custom-control custom-switch mb-4">
                    ...
                    <label class="custom-control-label RDP-Settings-text-small" for="customSwitch4">Is primary grouping by Amount</label>
                  </div>
              ...
              <div className="container">
                <div 
                  className="RDP-IRC-btn-section my-5 w-100"
                >
                  <Button 
...
export default RDP_InterestRateChart;
