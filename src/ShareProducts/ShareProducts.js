...
const ShareProducts = () => {
  ...
  const items = [{Name: 'A Product Name', Shortname: 'A-Pro', TotalShares: '23', Status: 'Active'},
  {Name: 'AY Product Name', Shortname: 'A-Pro', TotalShares: '15', Status: 'Active'},
  {Name: 'AYY Product Name', Shortname: 'A-Pro', TotalShares: '65', Status: 'Active'},
  {Name: 'B Product Name', Shortname: 'B-Pro', TotalShares: '14', Status: 'Active'},
  {Name: 'C Product Name', Shortname: 'C-Pro', TotalShares: '3', Status: 'Active'},
  {Name: 'D Product Name', Shortname: 'D-Pro', TotalShares: '12', Status: 'Inactive'},
  {Name: 'E Product Name', Shortname: 'E-Pro', TotalShares: '26', Status: 'Active'},
  {Name: 'F Product Name', Shortname: 'F-Pro', TotalShares: '67', Status: 'Inactive'},
  {Name: 'G Product Name', Shortname: 'G-Pro', TotalShares: '30', Status: 'Active'}];
